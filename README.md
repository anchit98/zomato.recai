...
1. User enters a query or selects preferences  
2. Frontend sends request to backend API  
3. Backend processes input and queries Supabase database  
4. AI model enhances results by interpreting intent and ranking recommendations  
5. Final results are returned and displayed to the user  
